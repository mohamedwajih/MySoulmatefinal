...
public class NotificationServices implements INotification {
 Connection connexion;
    ...
    public void addNotification(Notification n) {
        try {
            String query = "INSERT INTO notification (type_notification,texte_notification,date_notification,id_user_notif,etat_notif) "
                    + "values ( '"+n.getType_notification()+"','"+n.getTexte_notification()+"','"+java.sql.Date.valueOf(n.getDate_notification())+" ','"+n.getId_user_notif()+"',0)";
            Statement stm= connexion.createStatement();
            System.out.println(java.sql.Date.valueOf(n.getDate_notification()));
 ...
 public void addNotificationrdv(Notification n) {
        try {
            String query = "INSERT INTO notification (type_notification,texte_notification,date_notification,id_user_notif,etat_notif) "
                    + "values ( '"+n.getType_notification()+"','"+n.getTexte_notification()+"','"+n.getDate_notification2()+"','"+n.getId_user_notif()+"',0)";
            Statement stm= connexion.createStatement();
//            System.out.println(java.sql.Date.valueOf(n.getDate_notification()));
            stm.executeUpdate(query);
            System.out.println("Ajout effectué");
...
*/
  ...
  try {
            ...
            int etat=rs.getInt(6);
             Notification e = new Notification(id,etat,id_user,type,text,date);
             listN.add(e);
            }
        } catch (SQLException ex) {
  ...
  try {
            ...
            int etat=rs.getInt(6);
             Notification e = new Notification(id,etat,id_user_not,type,text,date);
             listN.add(e);
            }
        } catch (SQLException ex) {
            System.out.println(ex.getMessage());
